...
// This ensures that 'pl' and 'en' always have the exact same keys.
...
// ==========================================
// Section Data (Split for easier maintenance)
// ==========================================
...
const heroData: Record<Language, DictionarySchema["hero"]> = {
  ...
  pl: {
    bio: "Cześć! Projektuję strony minimalistyczne, responsywne i wizualnie dopracowane. \nZróbmy coś razem!",
  },
};
