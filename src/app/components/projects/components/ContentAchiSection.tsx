...
export default function ContentAchiSection({ project }: ContentAchiSectionProps) {
  ...
  return (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 lg:grid-rows-1 gap-5 place-items-stretch">
      ...
      <div className="flex flex-col">
        ...
        <ul className="mt-4 space-y-4 font-medium">
          {keyAchi.map((achivment, idx) => (
            <li key={idx} className="flex items-center text-xs lg:text-sm gap-4 tracking-[1.5%] leading-[19px]">
      ...
      <div className="col-span-2 overflow-hidden bottom-10 relative">
